                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">
                            ...
                            <span class="ml-3">Edit case : {{ $case->title }}</span>
                        </h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input autocomplete="off" type="text" id="inputName" name="user_id"
                                                        value="{{ $case->user->name }}" class="form-control" required readonly>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input autocomplete="off" type="text" id="inputName" name="service"
                                                        value="{{ $case->service }}" class="form-control" required readonly>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" autocomplete="off" id="inputName" name="next_hearing"
                                                        value="{{ $case->next_hearing->format('Y-m-d') }}"
